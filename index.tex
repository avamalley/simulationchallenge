...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, rightrule=.15mm, titlerule=0mm, breakable, colback=white, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{⚠️ AI Partnership Required}, arc=.35mm, opacitybacktitle=0.6, bottomrule=.15mm, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, rightrule=.15mm, titlerule=0mm, breakable, colback=white, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{🎯 Navy SEALs Motto}, arc=.35mm, opacitybacktitle=0.6, bottomrule=.15mm, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, rightrule=.15mm, titlerule=0mm, breakable, colback=white, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{💾 Important: Save Your Work Frequently!}, arc=.35mm, opacitybacktitle=0.6, bottomrule=.15mm, leftrule=.75mm, left=2mm]
...
\CommentTok{\# Create simulation data using base R}
...
\CommentTok{\# Calculate winnings}
\NormalTok{sim\_data}\SpecialCharTok{$}\NormalTok{winnings }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(sim\_data}\SpecialCharTok{$}\NormalTok{coin\_flip }\SpecialCharTok{==} \DecValTok{1}\NormalTok{, }\DecValTok{100}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{100}\NormalTok{)}
...
\CommentTok{\# Create time series plot using base R}
\FunctionTok{plot}\NormalTok{(time\_series\_data}\SpecialCharTok{$}\NormalTok{period, time\_series\_data}\SpecialCharTok{$}\NormalTok{balance, }
     \AttributeTok{type =} \StringTok{"b"}\NormalTok{, }\AttributeTok{col =} \StringTok{"cadetblue"}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{, }\AttributeTok{pch =} \DecValTok{19}\NormalTok{,}
     \AttributeTok{main =} \StringTok{"Account Balance Over Time}\SpecialCharTok{\textbackslash{}n}\StringTok{Single Simulation Path"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"Period"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Account Balance ($)"}\NormalTok{,}
     \AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{max}\NormalTok{(time\_series\_data}\SpecialCharTok{$}\NormalTok{balance) }\SpecialCharTok{*} \FloatTok{1.1}\NormalTok{))}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/timeseries-sim-r-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/timeseries-sim-python-1.pdf}}
...
\NormalTok{distribution\_data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{sim\_num =} \DecValTok{1}\SpecialCharTok{:}\NormalTok{n\_sims,}
  \AttributeTok{final\_balance =}\NormalTok{ final\_balances}
\NormalTok{)}

\CommentTok{\# Create histogram using base R}
\FunctionTok{hist}\NormalTok{(distribution\_data}\SpecialCharTok{$}\NormalTok{final\_balance, }
     \AttributeTok{breaks =} \DecValTok{20}\NormalTok{, }
     \AttributeTok{col =} \StringTok{"plum"}\NormalTok{, }
     \AttributeTok{border =} \StringTok{"black"}\NormalTok{,}
     \AttributeTok{main =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Distribution of Final Account Balances}\SpecialCharTok{\textbackslash{}n}\StringTok{100 Simulations,"}\NormalTok{, n\_periods, }\StringTok{"Periods Each"}\NormalTok{),}
     \AttributeTok{xlab =} \StringTok{"Final Balance ($)"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"Frequency"}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{v =}\NormalTok{ initial\_balance, }\AttributeTok{col =} \StringTok{"red"}\NormalTok{, }\AttributeTok{lty =} \DecValTok{2}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{)}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\StringTok{"Initial Balance"}\NormalTok{, }\AttributeTok{col =} \StringTok{"red"}\NormalTok{, }\AttributeTok{lty =} \DecValTok{2}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/distribution-sim-r-3.pdf}}
...
\NormalTok{mean\_balance }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(distribution\_data}\SpecialCharTok{$}\NormalTok{final\_balance)}
\NormalTok{median\_balance }\OtherTok{\textless{}{-}} \FunctionTok{median}\NormalTok{(distribution\_data}\SpecialCharTok{$}\NormalTok{final\_balance)}
\NormalTok{prob\_above\_initial }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(distribution\_data}\SpecialCharTok{$}\NormalTok{final\_balance }\SpecialCharTok{\textgreater{}}\NormalTok{ initial\_balance)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"Mean balance: $"}\NormalTok{, }\FunctionTok{round}\NormalTok{(mean\_balance, }\DecValTok{2}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\AttributeTok{sep =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"Median balance: $"}\NormalTok{, }\FunctionTok{round}\NormalTok{(median\_balance, }\DecValTok{2}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\AttributeTok{sep =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"Probability above initial: "}\NormalTok{, }\FunctionTok{round}\NormalTok{(prob\_above\_initial, }\DecValTok{3}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\AttributeTok{sep =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Probability above initial: 0.39
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/distribution-sim-python-1.pdf}}
